...
작업 전 다음 문서를 확인한다: [docs/branch-safety-guardrails.md](docs/branch-safety-guardrails.md), [docs/accessibility-decision-log.md](docs/accessibility-decision-log.md), [docs/content-structure-principles.md](docs/content-structure-principles.md).
