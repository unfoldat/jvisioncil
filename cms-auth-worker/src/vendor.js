// sveltia/sveltia-cms-auth 원본 그대로 vendoring (MIT). 코드 수정 없음 —
// upstream 업데이트와 diff 비교가 쉽도록 이 파일은 절대 손대지 않는다.
// rate limiting 등 우리 쪽 로직은 index.js에서 이 파일을 감싸는 방식으로 추가한다.
